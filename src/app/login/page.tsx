...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (message.includes("Invalid login credentials")) setError("이메일 또는 비밀번호가 올바르지 않습니다.");
      else if (message.includes("User already registered")) setError("이미 가입된 이메일입니다.");
      else if (message.includes("Password should be at least")) setError("비밀번호는 6자 이상이어야 합니다.");
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
          ...
          <button
            ...
            className="w-full bg-white border-2 border-gray-200 text-gray-700 py-3.5 rounded-xl font-semibold text-sm hover:bg-gray-50 hover:border-gray-300 transition-all flex items-center justify-center gap-3 mb-6 shadow-sm"
          >
